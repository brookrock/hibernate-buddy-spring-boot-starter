package io.brookrock.hibernate.integrated;
...
import io.brookrock.hibernate.convert.EnumArrayConverter;
import io.brookrock.hibernate.convert.EnumListConverter;
import io.brookrock.hibernate.convert.EnumSetConverter;
import io.brookrock.hibernate.convert.JsonConverter;
import io.brookrock.hibernate.type.JsonType;
...
public class IntegratedEntity implements Persistable<Long> {
	...
	@GenericGenerator(name = "snowflake", strategy = "io.brookrock.hibernate.id.SnowflakeIdentifierGenerator")
